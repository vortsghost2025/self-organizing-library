  ...
  return (
    <div className="mt-4 card p-4 animate-fade-in" role="region" aria-label="Truth routing legend">
      <div className="flex flex-wrap gap-x-6 gap-y-2 items-start">
        <div>
          <h3 className="text-xs font-medium uppercase tracking-wide text-[var(--text-secondary)] mb-1">Node Status</h3>
        ...
        <div>
          <h3 className="text-xs font-medium uppercase tracking-wide text-[var(--text-secondary)] mb-1">Authority Edges</h3>
